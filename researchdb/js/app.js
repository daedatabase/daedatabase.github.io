...
function signUp(){
    ...
    if(checknameValid == null){
        ...
        firebase.auth().createUserWithEmailAndPassword(email, password).then((success) => {
            ...
            var firebaseRef = firebase.database().ref().child('research');
            var userData = {
                name: name,
                cadreid: cadreid,
                cadre: cadre,
                ...
                userBio: "This is the message from me/ my bio",
            }
...
firebase.auth().onAuthStateChanged((user)=>{
    ...
    //   User is signed in.
        ...
        let firebaseRefKey = firebase.database().ref().child('research').child(uid);
